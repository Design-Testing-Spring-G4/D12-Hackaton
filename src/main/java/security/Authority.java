...
public class Authority implements GrantedAuthority {
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMIN + "|" + Authority.USER + "|" + Authority.MANAGER + "|" + Authority.INSTRUCTOR + "|" + Authority.AUDITOR + "|" + Authority.SPONSOR + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority = new Authority();
		authority.setAuthority(Authority.INSTRUCTOR);
		result.add(authority);
